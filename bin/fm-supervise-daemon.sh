...
#                                   tmux). Any other backend is not yet
#                                   supported as a supervisor backend; the daemon
...
# backend known to bin/fm-backend.sh has no verified composer/busy primitives
# wired up for this daemon yet - see
...
fm_super_main() {
  ...
  # tmux/herdr-specific call against it (any other backend has no verified
