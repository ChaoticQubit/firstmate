...
Pick tmux unless you have a specific reason to try the experimental herdr backend - tmux is the fully verified reference path for secondmate homes.
...
This mainly matters as an opt-out of herdr runtime auto-detection (see [`docs/herdr-backend.md`](herdr-backend.md)).
